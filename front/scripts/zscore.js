...
function getPercentile(average, globalMean, globalVariance) {
	let zscore = (average - globalMean) / Math.sqrt(globalVariance);
	
	return Math.round(zScoreToPercentile(zscore)*100);
}
